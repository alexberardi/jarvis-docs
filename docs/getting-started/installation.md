...
```bash
curl -fsSL https://raw.githubusercontent.com/alexberardi/jarvis-admin/v0.1.80/install.sh | sh
```
...
# Re-install
cd ~ && curl -fsSL https://raw.githubusercontent.com/alexberardi/jarvis-admin/v0.1.80/install.sh | sh
```
