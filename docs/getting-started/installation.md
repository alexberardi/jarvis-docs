...
```bash
curl -fsSL https://raw.githubusercontent.com/alexberardi/jarvis-admin/v0.1.90/install.sh | sh
```
...
# Re-install
cd ~ && curl -fsSL https://raw.githubusercontent.com/alexberardi/jarvis-admin/v0.1.90/install.sh | sh
```
