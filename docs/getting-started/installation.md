...
```bash
curl -fsSL https://raw.githubusercontent.com/alexberardi/jarvis-admin/v0.2.0/install.sh | sh
```
...
# Re-install
cd ~ && curl -fsSL https://raw.githubusercontent.com/alexberardi/jarvis-admin/v0.2.0/install.sh | sh
```
