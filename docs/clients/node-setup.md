...
```bash
curl -fsSL https://raw.githubusercontent.com/alexberardi/jarvis-node-setup/v0.1.145/install.sh | sudo bash
```
...
| `--version TAG` | Install a specific version (e.g. `v0.1.145`) |
