...
New devices are discovered automatically when a device protocol package is installed and the node scans the network. You can trigger a manual scan from the node detail screen.
